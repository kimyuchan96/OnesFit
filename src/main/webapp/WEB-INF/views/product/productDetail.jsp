            ...
            <head>
                ...
                <style>
                    * {
                    ...
                    #reviewtable th{ font-weight: normal; font-size: 12px;}
            ...
            <body>
                ...
                <div id=OSF_ALL>
                    ...
                    <div id="container">
                        ...
                        <div id="contents">
                            <div id='mainpic' style="padding: 20px; margin: auto; text-align: center; width: 500px; height: 500px; position: relative; left: 42px;">
                                <img src="/mainpic/${pdto.title_img }"
                                     style="width: 100%; height: 100%;">
                            </div>
                            <div id='maindetail' style="margin-top: 0px; margin-right: 0px; padding: 20px; height: 500px; color: #555555; position: relative; left: 70px; width: 480px;">
                                <form action="payMent" method="post" name="payMent">
                                    ...
                                    <div id='option'>
                                        <div>
                                            <b>COLOR</b>&nbsp; &nbsp;
                                            <select id='color' onchange="changeColor()" style="width: 50%">
                                        ...
                                        <div>
                                            <b>SIZE</b> &nbsp; &nbsp; &nbsp; &nbsp;
                                            <select id='size' style="width: 50%" onchange="selectSize()">
                                        ...
                                        <div id='totalPrice'>                                       
                                           <b>토탈 금액</b>&nbsp;&nbsp;<input type='number' name='sum' id='total' size='4'  readonly>KRW<br>
                                        </div>
                                     </div>
                                    <br>
                                    <div>
                                        <button class="btn btn-dark" id=buybtn
                                                ...
                                                style="width: 40%; height: 30px;
                                                       font-size: 13px; position: relative; bottom: 3px;">BUY NOW</button>&nbsp;&nbsp;
                                        <input type="button" value='CART' id='cartbtn'  style="width: 40%; height: 30px;
                                                                                               font-size: 13px;">
                            ...
                            <div id='subdetail'>
                                <div id='subdetailheader' style="position: relative; bottom: 100px; text-align: center;">
                                        ...
                                        <c:forEach var='i' items='${idto }'>
                                            <div style="width: 500px; height: 500px; float: left; padding: 20px">
                                                <img src="/subpic/${i.sysname }" style="width: 100%;">
                                                               ...
                                                               <table id="reviewtable" style="position: relative; left: 40px; font-size: 11px">
                                    <colgroup>
                                        <col style="width: 10%">
                                        <col style="width: 15%">
                                        <col style="width: 20%">
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="6" style="border: hidden; border-bottom: 1px solid #dfdfdf; text-align: left;"><b>REVIEW</b><br>
                                        ...
                                        <c:when test="${empty rdto}">
                                           <tr>
                                           <td colspan="6" align="center" style="height: 50px;">게시글이 없습니다.</td>
                                           </tr>
                                        </c:when>
                                        <c:otherwise>
                                        <c:forEach var='i' items='${rdto}'>
                                          <tr>
                                            ...
                                            <td style="border-right: hidden" ><img src="/product/${i.pseq}/review/${i.img }" style="width: 90px; height: 90px"></td>                     
                                            <td style="border-right: hidden" colspan='2'><a href="#" onclick="reviewDetail()">${i.title }</a></td>                                           
                                            <td style="border-right: hidden">${i.writer }</td>
                                            <td>${i.write_date }</td>
                                       	 </tr>
                                       	 <tr style="height:200px;" class='reviewDetail'>
                                       	 	<td>${i.bno }</td>
                                       	 	<td ><img src="/product/${i.pseq}/review/${i.img }" style="width: 200px; height: 200px;"></td>
                                       	 	<td colspan='4' style="vertical-align: top; text-align: left;padding:15px;"> ${i.content }</td>
                                       	 </tr>
                                        </c:forEach>
                                        </c:otherwise>
                                        </c:choose>
                                       
                                        <tr style="border-left: hidden; border-right: hidden; height: 50px;">
                                            <td colspan="6" style="text-align: right; border-bottom: hidden"> <input type="button" value="제품후기작성 " style="background-color: white;" id="reviewbtn1"></td>
                                        </tr>
                                    </thead>
                                </table>
                                ...
                                <table id="reviewtable_write" style="display: none;">
                                    ...
                                    <tr style="border-top: hidden;">
                                        ...
                                        <td  style="text-align: left;">&nbsp;&nbsp;<input name="title" type="text" style="width: 50%; height: 20px;"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="6"><textarea name="content" style="width: 100%; height: 250px; font-size: 12px;">키 - / 몸무게
...
- 상품 후기 - (20자 이상으로 작성해 주시기 바랍니다.)
                    ...
                    <div class="xbox" id='View_area' align=center style="border: 1px solid #dedede; width: 200px; height: 200px;">
                    ...
                    <div class="img_notice" style="font-size: 12px; text-align: center; color: green">200 x 200 권장</div> 
                    </div>
                    </td>
                                    </tr>
                                       <tr style="border: hidden; border-top: 1px">
                                        <td colspan="6" style="text-align: right"> <input type="submit" value="제품후기작성 " style="background-color: white; font-size: 12px;" id="reviewbtn2"></td>
                                    </tr> 
                                ...
                                <div class="footer" style="float: left; width: 1068px; margin-top: 50px;">
